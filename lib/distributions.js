...
// Read metadata of a distribution device
//
...
// Read distribution device metadata field
//
// https://m2x.att.com/developer/documentation/v2/distribution#Read-Distribution-Metadata-Field
Distributions.prototype.readMetadataField = function (id, metadatakey, callback) {
    return this.client.get(
        helpers.url("/distributions/%s/metadata/%s", id, metadatakey), callback);
};

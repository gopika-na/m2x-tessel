...
/**
 * @memberOf Collections
 * @description Method for [List Devices from an existing collection]{@link https://m2x.att.com/developer/documentation/v2/collections#List-Devices-from-an-existing-Collection} endpoint.
 * @param id {str} ID of the Collection to list the devices
 * @param callback {function} Response callback
